...
public interface XslHeaders {
    ...
    static String[] headerRowClickhouseSessions = new String[]{"DATE", "COUNT", "UNIQ(SESSIONS_UUID)", "DAY", "HOUR"};
    static String[] headerRowClickhouseEvents = new String[]{"DATE", "COUNT","DAY", "HOUR"};
}
