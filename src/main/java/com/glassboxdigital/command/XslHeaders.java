...
public interface XslHeaders {
    ...
    static String[] headerRowPs = new String[]{"RUNNING-DATE", "CPU", "MEMORY"};
    static String[] headerRowTop = new String[]{"RUNNING-DATE","PID", "USER", "PR", "NI", "VIRT", "RES", "SHR", "S", "%CPU", "%MEM", "TIME+", "COMMAND"};
